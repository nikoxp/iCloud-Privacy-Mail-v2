...
export async function login(username, password, setupRequired = false) {
  const data = await api(setupRequired ? '/api/auth/setup' : '/api/auth/login', {
    method: 'POST',
...
export function useAuth() {
  return { authState, loadAuthStatus, login, logout }
}
